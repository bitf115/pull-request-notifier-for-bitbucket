...
const FRONTEND_SRC_DIR = path.join(srcDir, 'main/js/pull-request-notifier-for-bitbucket');
...
const PLUGIN_KEY = 'se.bjurr.prnfb.pull-request-notifier-for-bitbucket';
